          ...
          <div>
            <div className="flex flex-col items-start mb-4 sm:mb-6">
              <span className="section-label">
                {product.category.toLowerCase() === 'hookah' ? 'Lifestyle Accessories' : product.category}
              </span>
            ...
            <div className="flex flex-wrap items-baseline gap-3 sm:gap-4">
              ...
              <span className="text-[10px] sm:text-xs text-muted-foreground uppercase tracking-[0.1em]">
